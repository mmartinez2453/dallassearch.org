...
<?
  ...
  define("STORE_DOMAIN", "dfwshooters.americommerce.com");
  define("API_USERNAME", "dfwshooters");
  define("API_PASSWORD", "V1d30Plus5@");
  define("SECURITY_TOKEN", "1052d968-7ae9-4a8f-a629-fd88004afe0d");
  ...
  try {
    ...
    $response = $client->Product_GetByKey(array("piitemID" => 6585));
